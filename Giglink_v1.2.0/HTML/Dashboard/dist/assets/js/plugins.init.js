 ...
 *          3. Accordions        *
 *     07. Upload Profile        *
 *     08. Custom Dropdown       * (For Dropdown)
 *     09. Connect wallet        * (Only For MetaMask)
 *     10. Datepicker js         *
 ================================*/
...
try {
    ...
    var setEndDate10 = "August 30, 2024 1:20:42";
    ...
    if(document.getElementById("auction-item-10"))
    setInterval(function(){ countDownTimer(cdd10, "auction-item-10"); }, 1000);
